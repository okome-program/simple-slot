...
function atlas_draw() {
  ...
  if (slot_ap > 192) { 
  	ctx.drawImage(img, 0, slot_ap, 32, slot_ap - (224 - slot_ap), 32, 128, 64, (224 - slot_ap) * 2);
    ctx.drawImage(img, 0, 0, 32, 32 - (slot_ap - (224 - slot_ap)), 32 , 128 + (224 - slot_ap), 64, (32 - (224 - slot_ap) * 2);
  }else {
